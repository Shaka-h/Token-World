<template>
  <main class="backgroundstyle h-full bg-black" style="">
    <NavBar />
    <div class="w-full ml-20 mt-20 flex flex-col">
...
import { wallet_address } from '@/scripts/WalletConnection';
